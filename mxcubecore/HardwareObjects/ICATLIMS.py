...
class ICATLIMS(AbstractLims):
    ...
    def login(
        ...
        return self.session_manager, icat_session.name, sessions
    ...
    def get_samples_by_investigation(self, investigation_id: str) -> List[Sample]:
        ...
        samples_List = []
        try:
            samples_List: List[Sample] = self._icat_client.get_samples_by(
                investigation_id=investigation_id
            )
    ...
    def _download_resources(
        ...
        for resource in resources:
            ...
            try:
                result = self._icat_client.download_file_by(str(sample_id), resource.id)
